...
router.get("/:from/:to", authMiddleware.verifyToken, dbConnectMiddleware.getCommentsFromTo, commentController.getAllComment); //Route get pour envoyer les comment du numéro X à Y
